 ...
 * A contact is considered unique by comparing using {@code Contact#isSamePerson(Contact)}. As such,
 * adding and updating of persons uses Contact#isSamePerson(Contact) for equality so as to ensure that
