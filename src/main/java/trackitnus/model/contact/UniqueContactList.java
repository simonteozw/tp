 ...
 * adding and updating of contacts uses Contact#isSameContact(Contact) for equality so as to ensure that
 * the contact being added or updated is unique in terms of identity in the UniqueContactList.
