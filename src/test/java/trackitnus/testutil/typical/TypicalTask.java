    ...
    public static List<Task> getConst() { // the dates of tasks must be constant for JSON testing
        return Arrays.asList(
            new Task(new Name("Plan for Alex's birthday"), ParserUtil.parseValidDate("12/12/2020"),
                null, "Buy a cake"),
            new Task(new Name("Buy Mooncakes for Mum"), ParserUtil.parseValidDate("08/11/2020"), null, ""),
            new Task(new Name("Do Tutorial"), ParserUtil.parseValidDate("10/11/2020"),
                new Code("CS2100"), ""),
            new Task(new Name("Catch up on Pipelining webcast"), ParserUtil.parseValidDate("03/11/2020"),
                new Code("CS2100"), "focus on latency and data forwarding"),
            new Task(new Name("Do this week's Mission"), ParserUtil.parseValidDate("08/11/2020"),
                new Code("CS1101S"), "Recursion"),
            new Task(new Name("Work on the final report"), ParserUtil.parseValidDate("05/11/2020"),
            ...
            new Task(new Name("Prepare for v1.4 Demo"), ParserUtil.parseValidDate("05/11/2020"),
                new Code("CS2103T"), "Ensure app runs smoothly"),
            new Task(new Name("Practical Exam on week 13"), ParserUtil.parseValidDate("10/11/2020"),
