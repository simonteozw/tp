...
public class AddLessonCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, "L add m/CS2030S t/recitation d/Wed 12:00-13:00 a/LT19",
        ...
        CommandParserTestUtil.assertParseSuccess(parser, "L add m/CS2100 t/LAB d/Mon 09:00-10:00 a/E-learning",
            new AddLessonCommand(TypicalLessons.CS2100_LAB));
        CommandParserTestUtil.assertParseSuccess(parser, "L add m/CS2030S t/REC d/Wed 12:00-13:00 a/LT19",
            new AddLessonCommand(TypicalLessons.CS2030S_REC));
        CommandParserTestUtil.assertParseSuccess(parser, "L add m/GER1000H t/SEC d/Fri 14:00-16:00 a/PGPH-FR4",
            new AddLessonCommand(TypicalLessons.GER1000H_SEC));
    }
