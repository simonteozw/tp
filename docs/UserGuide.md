...
(TODO: EDIT LESSON OUTCOME)
_FIgure ? - Example outcome of editing a lesson_
...
(TODO: ADD contact OUTCOME SCREENSHOT)
_Figure ? - Example outcome of adding a contact_
...
(TODO: ADD EDIT CONTACT OUTCOME)
_Figure ? - Example of editing a contact_
...
(TODO: DELETE CONTACT OUTCOME)
_Figure ? - Example of deleting a contact_
...
| Command | Example |
| ---- | ------ |
| **Add:** `M add m/CODE n/NAME` | `M add m/CS2100 n/Computer Organisation` |
| **Edit:** `M edit CODE [m/NEW_CODE] [n/NAME]` | `M edit CS1231 n/Discrete Structures` |
| **Delete:** `M delete CODE` | `M delete CS1101S` |
